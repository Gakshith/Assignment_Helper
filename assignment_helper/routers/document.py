"""Stub router: document. Registered by app.py at the seam-freeze; owned by exactly one strand.
...
def not_built(what: str) -> HTTPException:
    return HTTPException(
        status_code=501,
        detail={"code": "document.not-built", "message": f"{what} is not built yet."},
    )
